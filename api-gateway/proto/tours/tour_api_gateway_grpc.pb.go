...
func (c *tourServiceClient) GetTourById(ctx context.Context, in *GetTourRequest, opts ...grpc.CallOption) (*GetTourResponse, error) {
...
func (UnimplementedTourServiceServer) GetTourById(context.Context, *GetTourRequest) (*GetTourResponse, error) {
...
var TourService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "tour_api_gateway.proto",
}
